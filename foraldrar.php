...
/*---------------------------------------------------
foraldrar.php
Tävlingsinformation / Föräldrar / För Föräldrar
---------------------------------------------------*/
		...
		$artikelnames .= <<<END
			...
			<div class="collapse-in">
				...
				<ul class="">
	   				...
	   				<a href="foraldrar.php?ArtikelId={$artikelId}">
	   					<li>{$artikelname}</li>
	   				</a>	   									
	   			</ul>
			</div><!-- collapse -->
				...
				<div class="col-md-3">
					<div class="panel panel-blue">
						...
						<!-- Om oss undermeny -->
							...
							<h3 class="panel-title yellow">Info / Föräldrar</h3>
						</div><!-- panel heading -->
						</a>
