...
/*---------------------------------
resultat.php
Tävling / Tävlingar och resultat
---------------------------------*/
...
<div class="collapse-in" id="dokument">
	<ul class="meny">		
	   	<a href="resultat.php?ArtikelId={$artikelId}">
			<li>{$artikelname}</li>
		</a>	   									
	</ul>
</div><!-- collapse -->
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="panel panel-yellow">
				...
				<h3 class="panel-title blue bold">Tävla / Tävlingar och resultat</h3>
				</div><!-- panel heading -->					
