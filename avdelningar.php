...
<div class="panel panel-yellow">
	<div class="panel-heading">
		<h3 class="panel-title bold blue">{$artikelname}</h3>
	</div><!-- panel heading -->
...
<div class="panel panel-yellow">
	...
	<div class="panel-heading">
		<h4 class="panel-title blue bold">{$artikelname}</h4>
	</div><!-- panel heading -->
...
<div class="collapse-in" id="dokument">
	<ul class="meny">
  	<a href="avdelningar.php?ArtikelId={$artikelId}">
   		<li>{$artikelname}</li>
   	</a>							
   </ul>
</div><!-- collapse in -->
	...
	<div class="row">
		<div class="col-md-3">
			<div class="panel panel-yellow">
				...
				<div class="panel-heading">	
					<h4 class="panel-title blue bold">Avdelningar</h4>
				</div><!-- panel heading -->					
