...
/*---------------------------------------------------
riktlinjer.php
Förening / riktlinjer vid istidsförhandlingar
---------------------------------------------------*/
...
<div class="collapse-in" id="dokument">
	<ul class="meny">		
	   	<a href="riktlinjer.php?ArtikelId={$artikelId}">
			<li>{$artikelname}</li>
		</a>	   									
	</ul>
</div><!-- collapse -->
...
<div id="content">
	<div class="row">
		<div class="col-md-3">
			...
			<div class="panel panel-yellow">
				<div class="panel-heading">
					<h3 class="panel-title blue bold">Förening</h3>
				</div><!-- panel heading -->					
